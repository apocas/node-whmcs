...
Customers.prototype.updateService = function(serviceid, uoptions, callback) {
  var self = this;
  var options = {};

  _.extend(options, uoptions);

  options.action = 'upgradeproduct';
...
Customers.prototype.sendEmail = function (id, email, opts, callback) {
  ...
  options.id = id;
  if(email) options.messagename = email;
  options.responsetype = 'json';
