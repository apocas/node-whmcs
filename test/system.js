...
describe('Module "System"', function () {
  ...
  describe('Password encryption', function () {
    ...
    it('should encrypt a password', async function () {
      ...
      encryptedPassword = res.data.password;
    });
    ...
    it('should decrypt a password', async function () {
      ...
      expect(res).to.have.a.property('data');
      expect(res.data).to.have.a.property('result').to.equal('success');
      expect(res.data).to.have.a.property('password').to.equal(demoPassword);
    });
  });
  ...
  it('should get activity log', async function () {
    ...
    expect(res).to.have.a.property('data');
    expect(res.data).to.have.a.property('result').to.equal('success');
    expect(res.data).to.have.a.property('activity').to.be.an('object');
    expect(res.data.activity).to.have.a.property('entry').to.be.an('array');
  ...
  it('should get admin details', async function () {
    ...
    expect(res).to.have.a.property('data');
    expect(res.data).to.have.a.property('result').to.equal('success');
    expect(res.data).to.have.a.property('adminid').to.not.be.null;
  });

  it('should get admin users', async function () {
    let res = await conf.whmcs.system.getAdminUsers();
    expect(res).to.have.a.property('data');
    expect(res.data).to.have.a.property('admin_users').to.be.an('array');
  });
  ...
  it('should get automation log', async function () {
    ...
    expect(res).to.have.a.property('data');
    expect(res.data).to.have.a.property('result').to.equal('success');
    expect(res.data).to.have.a.property('currentDatetime').to.not.be.null;
  });
  ...
  it('should get configuration value', async function () {
    ...
    expect(res).to.have.a.property('data');
    expect(res.data).to.have.a.property('result').to.equal('success');
    expect(res.data).to.have.a.property('setting').to.not.be.null;
  ...
  it('should get currencies', async function () {
    ...
    expect(res).to.have.a.property('data');
    expect(res.data).to.have.a.property('result').to.equal('success');
    expect(res.data).to.have.a.property('currencies').to.be.an.an('object');
    expect(res.data.currencies).to.have.a.property('currency').to.be.an.an('array')
  });
  ...
  it('should get email templates', async function () {
    ...
    expect(res).to.have.a.property('data');
    expect(res.data).to.have.a.property('result').to.equal('success');
    expect(res.data).to.have.a.property('emailtemplates').to.be.an.an('object');
    expect(res.data.emailtemplates).to.have.a.property('emailtemplate').to.be.an.an('array');
  });
  ...
  it('should get payment methods', async function () {
    ...
    expect(res).to.have.a.property('data');
    expect(res.data).to.have.a.property('result').to.equal('success');
    expect(res.data).to.have.a.property('paymentmethods').to.be.an.an('object');
    expect(res.data.paymentmethods).to.have.a.property('paymentmethod').to.be.an.an('array');
  });
  ...
  it('should get staff online', async function () {
    ...
    expect(res).to.have.a.property('data');
    expect(res.data).to.have.a.property('result').to.equal('success');
    expect(res.data).to.have.a.property('staffonline').to.be.an.an('object');
    expect(res.data.staffonline).to.have.a.property('staff').to.be.an.an('array');
  });
  ...
  it('should get stats', async function () {
    ...
    expect(res).to.have.a.property('data');
    expect(res.data).to.have.a.property('result').to.equal('success');
    expect(res.data).to.have.a.property('income_today').to.not.be.null;
  });
  ...
  it('should get todo item statuses', async function () {
    ...
    expect(res).to.have.a.property('data');
    expect(res.data).to.have.a.property('result').to.equal('success');
    expect(res.data).to.have.a.property('todoitemstatuses').to.be.an.an('object');
    expect(res.data.todoitemstatuses).to.have.a.property('status').to.be.an.an('array');
  });
  ...
  it('should get whmcs details', async function () {
    ...
    expect(res).to.have.a.property('data');
    expect(res.data).to.have.a.property('result').to.equal('success');
    expect(res.data).to.have.a.property('whmcs').to.not.be.null;
  });
});